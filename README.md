...
🔁 **[REPRODUCE.md](REPRODUCE.md)** — one-command pipeline to regenerate every result/figure (`run_all.sh`). 📋 **[PROJECT\_ROADMAP.md](PROJECT_ROADMAP.md)** — the living tracker for finishing the analysis, making the repo FAIR, and preparing the Zenodo deposit and npj Microgravity manuscript. It contains the repository map, current status, the analysis roadmap (DEG → tissue-specific clustering → GO → PhysioSpace stress decoding), and FAIR/Zenodo/manuscript checklists.
